...
export const metadata: Metadata = {
  title: "Terms of Use",
  description: "Terms and conditions governing the use of PostIQ.",
};
    ...
    <article className="space-y-10">
      ...
      <Section>
        <p>
          ...
          of the PostIQ platform (&ldquo;Service&rdquo;), operated by Growth
      ...
      <Section number="1" title="Eligibility">
        <p>
          You must be at least 16 years old to use PostIQ. By using the
      ...
      <Section number="2" title="Account Registration">
        <p>
          To use PostIQ, you must create an account using a valid email
      ...
      <Section number="3" title="Permitted Use">
        <p>
          PostIQ is provided for the purpose of managing, scheduling,
      ...
      <Section number="4" title="Content Ownership">
        ...
        <p>
          ...
          through PostIQ, including post text, images, and media files. By
        ...
        <p>
          PostIQ provides AI-powered features including content suggestions,
        ...
        <p>
          The PostIQ platform, including its design, code, features,
      ...
      <Section number="5" title="Connected Platforms">
        <p>
          PostIQ allows you to connect third-party social media accounts to
          publish content and retrieve analytics. By connecting a platform
          account, you:
        </p>
        <ul>
          <li>
            Authorize PostIQ to access that platform on your behalf using
            OAuth 2.0
          </li>
          <li>
      ...
      <Section number="6" title="Scheduling and Publishing">
        <p>
          PostIQ provides content scheduling and automated publishing
        ...
        <p>
          ...
          Service. PostIQ does not pre-screen, review, or moderate content
      ...
      <Section number="7" title="AI Features and Limitations">
        <p>
          PostIQ incorporates AI-powered features to help you improve your
      ...
      <Section number="9" title="Fees and Payment">
        <p>
          PostIQ may offer free and paid subscription tiers. If you subscribe
      ...
      <Section number="10" title="Limitation of Liability">
        <p>
          To the maximum extent permitted by law, PostIQ and its officers,
      ...
      <Section number="12" title="Indemnification">
        <p>
          You agree to indemnify and hold harmless PostIQ and its affiliates,
      ...
      <Section number="14" title="Governing Law">
        <p>
          ...
          laws of the jurisdiction in which PostIQ is incorporated, without
      ...
      <Section number="15" title="Changes to These Terms">
        ...
        <p>
          Your continued use of PostIQ after the revised Terms take effect
      ...
      <Section number="17" title="Contact Us">
        ...
        <div className="rounded-lg border border-border bg-muted/40 px-4 py-3 text-sm">
          <p className="font-medium text-foreground">PostIQ</p>
          <p>
            Email:{" "}
            <a
              href="mailto:legal@postiq.so"
