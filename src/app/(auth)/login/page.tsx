...
export default function LoginPage() {
  ...
  return (
    <div className="flex w-full max-w-sm flex-col items-center px-6">
      ...
      {/* Editorial rule */}
      <div className="mb-8 h-px w-full bg-editorial-rule" />
      ...
      <Button
        ...
        variant="outline"
        size="lg"
        className="w-full cursor-pointer gap-3 border-input bg-transparent py-6 text-sm font-medium text-foreground transition-all duration-200 hover:border-ring/30 hover:bg-secondary/30"
      >
      ...
      {/* Footer */}
      <p className="mt-10 text-center text-[10px] uppercase tracking-[0.15em] text-muted-foreground/25">
